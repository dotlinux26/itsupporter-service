...
export function AdminDashboard() {
  ...
  return (
    <div className="container py-5 sm:py-8 md:py-12 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold text-text mb-6 sm:mb-8">{t('admin.dashboard')}</h1>
      ...
      <div className="card">
        <div className="p-4 border-b border-border flex items-center justify-between">
          <h3 className="font-semibold text-text">{t('admin.quickStats')}</h3>
        </div>
        <div className="p-4">
          <p className="text-center text-text-secondary py-8">{t('admin.quickStatsDesc')}</p>
        </div>
      </div>
    </div>
  );
