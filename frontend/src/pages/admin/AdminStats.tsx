    ...
    <div className="container py-10 md:py-12 max-w-6xl mx-auto">
      ...
      <div className="card">
        <div className="p-4 border-b border-border flex items-center justify-between">
          <h3 className="font-semibold text-text">Biểu đồ thống kê</h3>
        </div>
        <div className="p-4">
          <p className="text-center text-text-secondary py-8">Biểu đồ thống kê chi tiết sẽ hiển thị ở đây</p>
        </div>
      </div>
    </div>
  );
