    ...
    <div className="container py-5 sm:py-8 md:py-12 max-w-6xl mx-auto space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="card p-6 bg-gradient-to-br from-orange-500/10 via-orange-50/50 to-white border-orange-200 shadow-sm relative overflow-hidden">
          ...
          <div className="mt-4">
            <span className="text-xs font-semibold text-gray-500 block">Số dư chờ quyết toán</span>
            <div className="text-2xl sm:text-3xl font-extrabold text-primary font-mono tracking-tight mt-1">
              {(financeData.current_balance || 0).toLocaleString('vi-VN')} <span className="text-base font-semibold">đ</span>
            </div>
            <p className="text-[11px] text-gray-500 mt-1">
              Sẽ được quản lý chi trả vào đợt quyết toán kế tiếp.
            </p>
          </div>
        </div>
        ...
        <div className="card p-6 bg-white border border-gray-100 shadow-sm">
          ...
          <div className="mt-4">
            <span className="text-xs font-semibold text-gray-500 block">Tổng thu nhập tích lũy</span>
            <div className="text-2xl sm:text-3xl font-extrabold text-emerald-600 font-mono tracking-tight mt-1">
              {(financeData.total_earned || 0).toLocaleString('vi-VN')} <span className="text-base font-semibold">đ</span>
            </div>
            <p className="text-[11px] text-gray-400 mt-1">
              Bao gồm chia sẻ 70% doanh thu và phụ phí phát sinh.
            </p>
          </div>
        </div>
        ...
        <div className="card p-6 bg-white border border-gray-100 shadow-sm">
          ...
          <div className="mt-4">
            <span className="text-xs font-semibold text-gray-500 block">Đã quyết toán nhận tiền</span>
            <div className="text-2xl sm:text-3xl font-extrabold text-gray-900 font-mono tracking-tight mt-1">
              {(financeData.total_settled || 0).toLocaleString('vi-VN')} <span className="text-base font-semibold">đ</span>
            </div>
            <p className="text-[11px] text-gray-400 mt-1">
              {financeData.settlements?.length || 0} đợt chi trả đã hoàn tất.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="p-5">
              {currentOrders.length === 0 ? (
                <div className="py-8 text-center space-y-2">
                  ...
                  <p className="text-xs font-semibold text-gray-600">Bạn không có đơn nào đang dang dở</p>
                  <p className="text-[11px] text-gray-400">Hãy kiểm tra các đơn chờ xác nhận bên dưới.</p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-gray-500 flex items-center gap-2 mt-1">
                            ...
                            <span>
                              {order.scheduled_date ? format(new Date(order.scheduled_date), 'dd/MM/yyyy', { locale: vi }) : ''}{' '}
                      ...
                      <div className="flex items-center gap-3 self-end sm:self-center">
                        <span className="text-xs font-bold text-primary inline-flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                          Chi tiết & Xử lý <ChevronRight className="w-4 h-4" />
                        </span>
                      </div>
                    </Link>
                  ))}
          ...
          <div className="card bg-white border border-gray-100 shadow-sm overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-gray-900 text-base">Đơn mới chờ nhận ca ({pendingOrders.length})</h3>
              </div>
            ...
            <div className="p-5">
              {pendingOrders.length === 0 ? (
                <p className="text-center text-gray-400 py-6 text-xs">
                  Không có đơn hàng mới nào cần bạn tiếp nhận lúc này.
                </p>
              ) : (
                <div className="space-y-3">
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs text-gray-700 mt-1">
                          {order.package_name} · Khách: {order.customer_name}
                        </div>
                        <div className="text-[11px] text-gray-500 mt-0.5">
                          Hẹn lúc: {order.scheduled_start} ({order.scheduled_date})
                        </div>
                      </div>
          ...
          <div className="card bg-white border border-gray-100 shadow-sm overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-gray-900 text-base">Lịch hẹn hôm nay</h3>
              </div>
            ...
            <div className="p-4">
              {todaySchedule.length === 0 ? (
                <div className="py-6 text-center space-y-1">
                  <p className="text-xs text-gray-600 font-medium">Hôm nay không có lịch hẹn tiếp nhận máy</p>
                  <p className="text-[11px] text-gray-400">Bạn có thể tranh thủ bảo dưỡng dụng cụ và thiết bị.</p>
                </div>
              ) : (
            ...
            <div className="p-3 border-t border-gray-100 bg-gray-50/50 text-center">
              <Link to="/technician/schedule" className="text-xs font-semibold text-primary hover:underline">
                Xem lịch trực toàn tuần & cấu hình ca trực →
              </Link>
            </div>
          </div>
          ...
          <div className="card bg-white border border-gray-100 shadow-sm overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-gray-900 text-base">Lịch sử quyết toán</h3>
              </div>
            </div>

            <div className="p-4 divide-y divide-gray-100 text-xs">
              {financeData.settlements?.length === 0 ? (
                <p className="text-center text-gray-400 py-6">Chưa có phiếu quyết toán nào được lập.</p>
              ) : (
                  ...
                  <div key={s.id} className="py-2.5 flex items-center justify-between first:pt-0 last:pb-0">
                    ...
                    <div className="text-right">
                      <span className="font-bold font-mono text-emerald-600 block">
                        +{Number(s.amount).toLocaleString('vi-VN')} đ
                      </span>
